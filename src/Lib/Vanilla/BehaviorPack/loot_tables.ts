...
[
  ...
  "loot_tables/entities/armor_set_diamond.json",
  "loot_tables/entities/armor_set_gold.json",
  "loot_tables/entities/armor_set_iron.json",
  "loot_tables/entities/armor_set_leather.json",
  "loot_tables/entities/armor_stand.json",
  ...
  "loot_tables/entities/cave_spider.json",
  "loot_tables/entities/chicken.json",
  "loot_tables/entities/clownfish.json",
  "loot_tables/entities/cold_ocean_ruins_brushable_block.json",
  "loot_tables/entities/cow.json",
  "loot_tables/entities/creeper.json",
  "loot_tables/entities/desert_pyramid_brushable_block.json",
  "loot_tables/entities/desert_well_brushable_block.json",
  "loot_tables/entities/dolphin.json",
  "loot_tables/entities/drowned_equipment.json",
  "loot_tables/entities/drowned_ranged_equipment.json",
  "loot_tables/entities/drowned.json",
  "loot_tables/entities/elder_guardian.json",
  "loot_tables/entities/empty_brushable_block.json",
  "loot_tables/entities/enderman.json",
  "loot_tables/entities/endermite.json",
  ...
  "loot_tables/entities/iron_golem.json",
  "loot_tables/entities/llama.json",
  "loot_tables/entities/magma_cube.json",
  "loot_tables/entities/mooshroom_shear.json",
  "loot_tables/entities/mooshroom.json",
  "loot_tables/entities/ocelot.json",
  "loot_tables/entities/panda_sneeze.json",
  "loot_tables/entities/panda.json",
  "loot_tables/entities/parrot.json",
  "loot_tables/entities/phantom.json",
  "loot_tables/entities/pig_saddled.json",
  "loot_tables/entities/pig.json",
  "loot_tables/entities/piglin_barter.json",
  "loot_tables/entities/piglin_brute_gear.json",
  ...
  "loot_tables/entities/polar_bear.json",
  "loot_tables/entities/pufferfish.json",
  ...
  "loot_tables/entities/sheep_shear.json",
  "loot_tables/entities/sheep_sheared.json",
  "loot_tables/entities/sheep.json",
  "loot_tables/entities/shulker.json",
  "loot_tables/entities/silverfish.json",
  "loot_tables/entities/skeleton_gear.json",
  "loot_tables/entities/skeleton_horse.json",
  "loot_tables/entities/skeleton.json",
  "loot_tables/entities/slime.json",
  "loot_tables/entities/snow_golem_shear.json",
  "loot_tables/entities/snowman.json",
  "loot_tables/entities/spider.json",
  "loot_tables/entities/squid.json",
  "loot_tables/entities/stray.json",
  "loot_tables/entities/strider_saddled.json",
  "loot_tables/entities/strider.json",
  ...
  "loot_tables/entities/vex_gear.json",
  ...
  "loot_tables/entities/wolf.json",
  "loot_tables/entities/zoglin.json",
  "loot_tables/entities/zombie_equipment.json",
  "loot_tables/entities/zombie_horse.json",
  "loot_tables/entities/zombie_pigman_gear.json",
